...
server.tool("navigate", "Navigate to a URL. Uses the saved Chrome profile so LinkedIn sessions persist.", { url: z.string().min(1).describe("URL to open (https://... or example.com)") }, async ({ url }) => {
